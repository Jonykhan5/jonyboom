...
banner() {
    ...
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By JONY \e[1;32mSpeedX \e[0m"
    else
        echo -e "\e[1;34mCreated By Jony \e[1;34m"
        toilet -f mono12 -F border SpeedX
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           Facebook: https://www.facebook.com/jonykhan57 \e[0m"
    echo -e "\e[4;32m   whatsapp: +8801724066357 \e[0m"
    echo " "
    echo "NOTE: Kindly move to the PIP version Of Jony for more stability."
    echo " "
}
